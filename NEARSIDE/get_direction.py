...
parser.add_argument('--data_dir', type=str, default="minigpt_hh_train_hidden_f")
parser.add_argument('--save_file', type=str, default="minigpt_hh_train_direction_f.pkl")
args = parser.parse_args()

emb_files = os.listdir(args.data_dir)
emb_files = sorted(emb_files)

all_emb = []
for emb_file in tqdm(emb_files):
    with open(os.path.join(args.data_dir, emb_file), "rb") as f:
