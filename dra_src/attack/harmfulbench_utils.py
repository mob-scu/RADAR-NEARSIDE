...
attack_config = json.load(open('/data/tangjingkun/DRA_utiles/dra_src/attack/attack_config.json', 'r'))
model_path = '/data/huangyoucheng/models/HarmBench-Llama-2-13b-cls'
cls = AutoModelForCausalLM.from_pretrained(model_path, torch_dtype=torch.bfloat16, device_map=torch.device('cuda:0'))
